...
| 04-004 | AI Task CRUD | 04 | [x] Done |  | true | 03-004 | 05-002 | cli, ai-task | feature/current/portfolio-layer/story-04-004-ai-task-crud |
...
| 06-003 | Priority order table + drag-and-drop persistence + CLI reordering | 06 | [x] Done |  | true | 05-002 | — | db, priority | feature/current/portfolio-layer/story-06-003-priority-ordering |
